...
import { Home, Truck, FileSignature, Receipt, FileText, Plus, LogOut, WifiOff, HelpCircle, Wrench, HandCoins } from 'lucide-react';
...
const tabs = [
  ...
  { to: '/adiantamentos', icon: HandCoins, label: 'Adiant.', tourKey: 'tab-adiantamentos' },
